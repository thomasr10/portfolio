        ...
        <section className="about-section">
            <div className="raw-limit-size center about-section-container">
                <div className="about-me">
                    ...
                    <p className="white-txt-regular">Je m’appelle Thomas Rivoire, étudiant en développement web et web mobile. Après avoir acquis les bases du développement front-end et back-end, je poursuis mon parcours en intégrant un Bachelor 3 Développement afin de consolider mes compétences et d’élargir mes connaissances.</p>
